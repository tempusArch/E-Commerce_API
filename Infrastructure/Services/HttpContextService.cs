...
public class HttpContextService : IHttpContextService {
    ...
    public HttpContextService(ECommerceApiDbContext context, IHttpContextAccessor httpContextAccessor) {
        _context = context;
    ...
    public void SetRefreshToken(RefreshTokenModel newRefreshToken) {
