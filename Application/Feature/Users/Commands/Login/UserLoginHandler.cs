...
public class UserLoginHandler : IRequestHandler<UserLoginCommand, User> {
    private readonly ECommerceApiDbContext _context;
    private readonly IMapper _mapper;
    private readonly IJwtService _jwtService;
    private readonly IPasswordHasher _passwordHasher;
    public UserLoginHandler(ECommerceApiDbContext context, IMapper mapper, IJwtService jwtService, IPasswordHasher passordHasher) {
        _context = context;
        _mapper = mapper;
