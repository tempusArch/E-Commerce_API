...
public class CreatePaymentIntent {
    ...
    public class Handler : IRequestHandler<CreatePaymentIntentCommand, string> {
        ...
        public async Task<string> Handle(CreatePaymentIntentCommand command, CancellationToken cancellationToken) {
            var theOrder = await _context.OrderTable
                .AsNoTracking()
                .FirstOrDefaultAsync(o => o.UserId == command.UserId && o.Id == command.OrderId, cancellationToken);
