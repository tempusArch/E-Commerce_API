...
public class UpdateCartItemHandler : IRequestHandler<UpdateCartItemCommand, SingleCartItemDto> {
    private readonly ECommerceApiDbContext _context;
    public UpdateCartItemHandler(ECommerceApiDbContext context) {
        _context = context;         
    }

    public async Task<SingleCartItemDto> Handle(UpdateCartItemCommand command, CancellationToken cancellationToken) {
